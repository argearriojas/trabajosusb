...
%%	En los comentarios se pueden encontrar los diferentes comandos que se pueden
%%	usar para personalizar el trabajo.
%%
%%	La clase tesisusb está basada por la que creó Kevin Hernandez en 2005.
%%	Se recomienda el uso del motor texlive-xetex.
%%
%%	Se dispone de un comando para insertar imágenes: \imagen[]{}
%%	se usa en forma parecida a \includegraphics, pero puede dibujar
%%	marcos y sombras. El código fuente que permite hacer esto fue
%%	conseguido en http://tex.stackexchange.com/a/11483/3954

%%	La clase tesisusb carga por defecto los siguientes paquetes:
%%		graphicx
%%		fontspec 			- Para letras acentuadas, sólo con xetex.
%%		inputenc con utf8 	- Para letras acentuadas, si no se usa xetex.
%%
%%	Opciones para la clase tesisusb.cls
%%		ttftimes		- Para usar Times New Roman verdadero. Requiere ttf-mscorefonts.
\documentclass[ttftimes]{tesisusb}
...
\include{lib/config}			% Para incluir los paquetes extra que se necesiten
\usepackage{lipsum}

\include{lib/funciones}		% Para definir los nuevos comandos que se necesiten
